...
### Usage
1) Download the [Jar file](https://github.com/Lenddo/java-lenddo/releases/download/v2.0.0/LenddoApi.zip) and add the LenddoApi.jar to your Java project as library.
