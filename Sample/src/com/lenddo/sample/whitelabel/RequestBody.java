    ...
    private String setMethodString(int method) {
        switch (method) {
            ...
            case POST_METHOD:
                ...
                break;
            default:
                System.out.println("setMethodString(method) Unknown method value: " + method);
                this.method = "";
                break;
        }
        return this.method;
    ...
    private String setPath(int endpoint, String applicationId) {
        ...
        switch (endpoint) {
            ...
            case ENDPOINT_APPLICATIONS:
                ...
                break;
            default:
                System.out.println("setPath(endpoint, applicationId) Unknown endpoint value: " + endpoint);
                path = "";
                break;
        }
        return this.path;
