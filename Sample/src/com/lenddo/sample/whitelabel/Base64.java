...
/* ********  E N C O D I N G   M E T H O D S  ******** */
    ...
    public static String encodeObject( java.io.Serializable serializableObject, int options )
        ...
        try {
            ...
            if (gzos!=null) try{ gzos.close(); } catch( Exception e ){ e.printStackTrace(); }
...
//        }
        ...
        if( (bytes != null) && (bytes.length >= 4) && (!dontGunzip) ) {
            ...
            if( java.util.zip.GZIPInputStream.GZIP_MAGIC == head )  {
                ...
                try {
                    ...
                    if (baos!=null) try{ baos.close(); } catch( Exception e ){ e.printStackTrace(); }
                    if (gzis!=null) try{ gzis.close(); } catch( Exception e ){ e.printStackTrace(); }
    ...
    public static void encodeFileToFile( String infile, String outfile )
        ...
        try{
            ...
            if (out!=null) try { out.close(); } catch( Exception ex ){ ex.printStackTrace(); }
        }   // end finally
