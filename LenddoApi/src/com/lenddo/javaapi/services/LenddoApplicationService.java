...
public interface LenddoApplicationService {
    ...
    @GET("/applications/partnerscripts/{partner_script_id}")
    Call<EncryptedResponse> getApplicationsWithFilter(@Path("partner_script_id") String partner_script_id,
                                            @Header("Date") String date,
                                            @Header("Authorization") String authorization,
                                            @Query("page_size") double page_size,
                                            @Query("page_number") double page_number,
